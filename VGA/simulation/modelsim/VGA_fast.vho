...
SIGNAL \C1|LessThan17~0_combout\ : std_logic;
...
SIGNAL \C1|SQ_Y1[1]~0_combout\ : std_logic;
...
SIGNAL \C1|LessThan17~1_combout\ : std_logic;
...
-- Equation(s):
-- \C1|Add2~4_combout\ = (\C1|SQ_X2\(5) & (\C1|Add2~3\ $ (GND))) # (!\C1|SQ_X2\(5) & (!\C1|Add2~3\ & VCC))
...
-- Equation(s):
-- \C1|Add2~6_combout\ = (\C1|SQ_X2\(6) & ((\C1|Add2~5\) # (GND))) # (!\C1|SQ_X2\(6) & (!\C1|Add2~5\))
...
-- Equation(s):
-- \C1|Add3~2_combout\ = (\C1|SQ_Y2\(2) & (\C1|Add3~1_cout\ & VCC)) # (!\C1|SQ_Y2\(2) & (!\C1|Add3~1_cout\))
-- \C1|Add3~3\ = CARRY((!\C1|SQ_Y2\(2) & !\C1|Add3~1_cout\))
...
-- Equation(s):
-- \C1|Add3~10_combout\ = (\C1|SQ_Y2\(6) & ((\C1|Add3~9\) # (GND))) # (!\C1|SQ_Y2\(6) & (!\C1|Add3~9\))
-- \C1|Add3~11\ = CARRY((\C1|SQ_Y2\(6)) # (!\C1|Add3~9\))
...
-- Equation(s):
-- \C1|Add10~0_combout\ = \C1|SQ_X2\(1) $ (VCC)
-- \C1|Add10~1\ = CARRY(\C1|SQ_X2\(1))
...
-- Equation(s):
-- \C1|Add10~6_combout\ = (\C1|SQ_X2\(4) & ((\KEY~combout\(1) & ((\C1|Add10~5\) # (GND))) # (!\KEY~combout\(1) & (!\C1|Add10~5\)))) # (!\C1|SQ_X2\(4) & ((\KEY~combout\(1) & (!\C1|Add10~5\)) # (!\KEY~combout\(1) & (\C1|Add10~5\ & VCC))))
-- \C1|Add10~7\ = CARRY((\C1|SQ_X2\(4) & ((\KEY~combout\(1)) # (!\C1|Add10~5\))) # (!\C1|SQ_X2\(4) & (\KEY~combout\(1) & !\C1|Add10~5\)))
...
-- Equation(s):
-- \C1|Add10~14_combout\ = (\C1|SQ_X2\(8) & ((\KEY~combout\(1) & (!\C1|Add10~13\)) # (!\KEY~combout\(1) & (\C1|Add10~13\ & VCC)))) # (!\C1|SQ_X2\(8) & ((\KEY~combout\(1) & ((\C1|Add10~13\) # (GND))) # (!\KEY~combout\(1) & (!\C1|Add10~13\))))
-- \C1|Add10~15\ = CARRY((\C1|SQ_X2\(8) & (\KEY~combout\(1) & !\C1|Add10~13\)) # (!\C1|SQ_X2\(8) & ((\KEY~combout\(1)) # (!\C1|Add10~13\))))
...
-- Equation(s):
-- \C1|Add10~16_combout\ = ((\C1|SQ_X2\(9) $ (\KEY~combout\(1) $ (!\C1|Add10~15\)))) # (GND)
-- \C1|Add10~17\ = CARRY((\C1|SQ_X2\(9) & (!\KEY~combout\(1) & !\C1|Add10~15\)) # (!\C1|SQ_X2\(9) & ((!\C1|Add10~15\) # (!\KEY~combout\(1)))))
...
-- Equation(s):
-- \C1|Add10~18_combout\ = \C1|SQ_X2\(10) $ (\C1|Add10~17\ $ (!\KEY~combout\(1)))
...
-- Equation(s):
-- \C1|Add13~4_combout\ = ((\C1|SQ_Y2\(3) $ (\KEY~combout\(3) $ (\C1|Add13~3\)))) # (GND)
-- \C1|Add13~5\ = CARRY((\C1|SQ_Y2\(3) & (\KEY~combout\(3) & !\C1|Add13~3\)) # (!\C1|SQ_Y2\(3) & ((\KEY~combout\(3)) # (!\C1|Add13~3\))))
...
-- Equation(s):
-- \C1|SQ_X2[9]~1_combout\ = !\C1|Add10~16_combout\
...
-- Equation(s):
-- \C1|SQ_Y2[3]~4_combout\ = !\C1|Add13~4_combout\
...
-- Equation(s):
-- \C1|LessThan12~0_combout\ = (!\C1|HPOS\(5) & (!\C1|HPOS\(6) & ((!\C1|HPOS\(3)) # (!\C1|HPOS\(4)))))
...
-- Equation(s):
-- \C1|LessThan9~1_combout\ = (!\C1|LessThan9~0_combout\ & ((\C1|HPOS\(8)) # ((\C1|HPOS\(7) & !\C1|LessThan12~0_combout\))))
...
-- Equation(s):
-- \C1|LessThan14~0_combout\ = (!\C1|VPOS\(4) & (((!\C1|VPOS\(2) & !\C1|VPOS\(1))) # (!\C1|VPOS\(3))))
...
-- Equation(s):
-- \C1|LessThan10~0_combout\ = (\C1|VPOS\(10) & (((\C1|VPOS\(5) & !\C1|LessThan14~0_combout\)) # (!\C1|process_0~5_combout\)))
...
\C1|LessThan17~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \C1|LessThan17~0_combout\ = (!\C1|VPOS\(4) & (!\C1|VPOS\(3) & !\C1|VPOS\(2)))
...
PORT MAP (
	...
	datab => \C1|VPOS\(3),
	datac => \C1|VPOS\(2),
	combout => \C1|LessThan17~0_combout\);

-- Location: LCCOMB_X29_Y15_N4
\C1|process_0~4\ : cycloneii_lcell_comb
-- Equation(s):
-- \C1|process_0~4_combout\ = ((\C1|VPOS\(10)) # ((!\C1|VPOS\(0) & !\C1|VPOS\(1)))) # (!\C1|LessThan17~0_combout\)
...
-- Equation(s):
-- \C1|process_0~6_combout\ = ((\C1|process_0~4_combout\) # (\C1|VPOS\(5))) # (!\C1|process_0~5_combout\)
...
-- Equation(s):
-- \C1|Add13~0_combout\ = \C1|SQ_Y2\(1) $ (VCC)
-- \C1|Add13~1\ = CARRY(\C1|SQ_Y2\(1))
...
\C1|SQ_Y1[1]~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \C1|SQ_Y1[1]~0_combout\ = (!\KEY~combout\(2)) # (!\KEY~combout\(3))
...
-- Equation(s):
-- \C1|SQ_Y2[1]~0_combout\ = (\C1|LessThan10~0_combout\ & (\C1|SQ_Y1[1]~0_combout\ & (\C1|LessThan9~1_combout\ & \SW~combout\(1))))
...
PORT MAP (
	...
	datab => \C1|SQ_Y1[1]~0_combout\,
	datac => \C1|LessThan9~1_combout\,
	datad => \SW~combout\(1),
...
-- Equation(s):
-- \C1|Add13~2_combout\ = (\KEY~combout\(3) & ((\C1|SQ_Y2\(2) & (\C1|Add13~1\ & VCC)) # (!\C1|SQ_Y2\(2) & (!\C1|Add13~1\)))) # (!\KEY~combout\(3) & ((\C1|SQ_Y2\(2) & (!\C1|Add13~1\)) # (!\C1|SQ_Y2\(2) & ((\C1|Add13~1\) # (GND)))))
-- \C1|Add13~3\ = CARRY((\KEY~combout\(3) & (!\C1|SQ_Y2\(2) & !\C1|Add13~1\)) # (!\KEY~combout\(3) & ((!\C1|Add13~1\) # (!\C1|SQ_Y2\(2)))))
...
-- Equation(s):
-- \C1|Add13~6_combout\ = (\C1|SQ_Y2\(4) & ((\KEY~combout\(3) & (!\C1|Add13~5\)) # (!\KEY~combout\(3) & ((\C1|Add13~5\) # (GND))))) # (!\C1|SQ_Y2\(4) & ((\KEY~combout\(3) & (\C1|Add13~5\ & VCC)) # (!\KEY~combout\(3) & (!\C1|Add13~5\))))
-- \C1|Add13~7\ = CARRY((\C1|SQ_Y2\(4) & ((!\C1|Add13~5\) # (!\KEY~combout\(3)))) # (!\C1|SQ_Y2\(4) & (!\KEY~combout\(3) & !\C1|Add13~5\)))
...
-- Equation(s):
-- \C1|Add13~8_combout\ = ((\C1|SQ_Y2\(5) $ (\KEY~combout\(3) $ (!\C1|Add13~7\)))) # (GND)
-- \C1|Add13~9\ = CARRY((\C1|SQ_Y2\(5) & ((\KEY~combout\(3)) # (!\C1|Add13~7\))) # (!\C1|SQ_Y2\(5) & (\KEY~combout\(3) & !\C1|Add13~7\)))
...
-- Equation(s):
-- \C1|Add13~10_combout\ = (\C1|SQ_Y2\(6) & ((\KEY~combout\(3) & (!\C1|Add13~9\)) # (!\KEY~combout\(3) & ((\C1|Add13~9\) # (GND))))) # (!\C1|SQ_Y2\(6) & ((\KEY~combout\(3) & (\C1|Add13~9\ & VCC)) # (!\KEY~combout\(3) & (!\C1|Add13~9\))))
-- \C1|Add13~11\ = CARRY((\C1|SQ_Y2\(6) & ((!\C1|Add13~9\) # (!\KEY~combout\(3)))) # (!\C1|SQ_Y2\(6) & (!\KEY~combout\(3) & !\C1|Add13~9\)))
...
-- Equation(s):
-- \C1|Add13~12_combout\ = ((\C1|SQ_Y2\(7) $ (\KEY~combout\(3) $ (!\C1|Add13~11\)))) # (GND)
-- \C1|Add13~13\ = CARRY((\C1|SQ_Y2\(7) & ((\KEY~combout\(3)) # (!\C1|Add13~11\))) # (!\C1|SQ_Y2\(7) & (\KEY~combout\(3) & !\C1|Add13~11\)))
...
-- Equation(s):
-- \C1|Add13~14_combout\ = (\C1|SQ_Y2\(8) & ((\KEY~combout\(3) & (\C1|Add13~13\ & VCC)) # (!\KEY~combout\(3) & (!\C1|Add13~13\)))) # (!\C1|SQ_Y2\(8) & ((\KEY~combout\(3) & (!\C1|Add13~13\)) # (!\KEY~combout\(3) & ((\C1|Add13~13\) # (GND)))))
-- \C1|Add13~15\ = CARRY((\C1|SQ_Y2\(8) & (!\KEY~combout\(3) & !\C1|Add13~13\)) # (!\C1|SQ_Y2\(8) & ((!\C1|Add13~13\) # (!\KEY~combout\(3)))))
...
-- Equation(s):
-- \C1|Add13~16_combout\ = ((\C1|SQ_Y2\(9) $ (\KEY~combout\(3) $ (\C1|Add13~15\)))) # (GND)
-- \C1|Add13~17\ = CARRY((\C1|SQ_Y2\(9) & (\KEY~combout\(3) & !\C1|Add13~15\)) # (!\C1|SQ_Y2\(9) & ((\KEY~combout\(3)) # (!\C1|Add13~15\))))
...
-- Equation(s):
-- \C1|Add13~18_combout\ = \C1|SQ_Y2\(10) $ (\C1|Add13~17\ $ (\KEY~combout\(3)))
...
-- Equation(s):
-- \C1|SQ_Y2[9]~1_combout\ = !\C1|Add13~16_combout\
...
-- Equation(s):
-- \C1|SQ_Y2[6]~2_combout\ = !\C1|Add13~10_combout\
...
-- Equation(s):
-- \C1|SQ_Y2[4]~3_combout\ = !\C1|Add13~6_combout\
...
-- Equation(s):
-- \C1|Add10~2_combout\ = (\C1|SQ_X2\(2) & ((\KEY~combout\(1) & (!\C1|Add10~1\)) # (!\KEY~combout\(1) & (\C1|Add10~1\ & VCC)))) # (!\C1|SQ_X2\(2) & ((\KEY~combout\(1) & ((\C1|Add10~1\) # (GND))) # (!\KEY~combout\(1) & (!\C1|Add10~1\))))
-- \C1|Add10~3\ = CARRY((\C1|SQ_X2\(2) & (\KEY~combout\(1) & !\C1|Add10~1\)) # (!\C1|SQ_X2\(2) & ((\KEY~combout\(1)) # (!\C1|Add10~1\))))
...
-- Equation(s):
-- \C1|Add10~4_combout\ = ((\C1|SQ_X2\(3) $ (\KEY~combout\(1) $ (!\C1|Add10~3\)))) # (GND)
-- \C1|Add10~5\ = CARRY((\C1|SQ_X2\(3) & (!\KEY~combout\(1) & !\C1|Add10~3\)) # (!\C1|SQ_X2\(3) & ((!\C1|Add10~3\) # (!\KEY~combout\(1)))))
...
-- Equation(s):
-- \C1|Add10~8_combout\ = ((\C1|SQ_X2\(5) $ (\KEY~combout\(1) $ (\C1|Add10~7\)))) # (GND)
-- \C1|Add10~9\ = CARRY((\C1|SQ_X2\(5) & ((!\C1|Add10~7\) # (!\KEY~combout\(1)))) # (!\C1|SQ_X2\(5) & (!\KEY~combout\(1) & !\C1|Add10~7\)))
...
-- Equation(s):
-- \C1|Add10~10_combout\ = (\C1|SQ_X2\(6) & ((\KEY~combout\(1) & ((\C1|Add10~9\) # (GND))) # (!\KEY~combout\(1) & (!\C1|Add10~9\)))) # (!\C1|SQ_X2\(6) & ((\KEY~combout\(1) & (!\C1|Add10~9\)) # (!\KEY~combout\(1) & (\C1|Add10~9\ & VCC))))
-- \C1|Add10~11\ = CARRY((\C1|SQ_X2\(6) & ((\KEY~combout\(1)) # (!\C1|Add10~9\))) # (!\C1|SQ_X2\(6) & (\KEY~combout\(1) & !\C1|Add10~9\)))
...
-- Equation(s):
-- \C1|Add10~12_combout\ = ((\C1|SQ_X2\(7) $ (\KEY~combout\(1) $ (\C1|Add10~11\)))) # (GND)
-- \C1|Add10~13\ = CARRY((\C1|SQ_X2\(7) & ((!\C1|Add10~11\) # (!\KEY~combout\(1)))) # (!\C1|SQ_X2\(7) & (!\KEY~combout\(1) & !\C1|Add10~11\)))
...
-- Equation(s):
-- \C1|SQ_X1[1]~0_combout\ = (!\KEY~combout\(0)) # (!\KEY~combout\(1))
...
-- Equation(s):
-- \C1|SQ_X2[1]~0_combout\ = (\SW~combout\(1) & (\C1|SQ_X1[1]~0_combout\ & (\C1|LessThan10~0_combout\ & \C1|LessThan9~1_combout\)))
...
-- Equation(s):
-- \C1|SQ_X2[6]~2_combout\ = !\C1|Add10~10_combout\
...
-- Equation(s):
-- \C1|LessThan5~5_cout\ = CARRY((\C1|Add2~0_combout\ & ((!\C1|LessThan5~3_cout\) # (!\C1|HPOS\(3)))) # (!\C1|Add2~0_combout\ & (!\C1|HPOS\(3) & !\C1|LessThan5~3_cout\)))
...
-- Equation(s):
-- \C1|LessThan5~7_cout\ = CARRY((\C1|Add2~2_combout\ & (\C1|HPOS\(4) & !\C1|LessThan5~5_cout\)) # (!\C1|Add2~2_combout\ & ((\C1|HPOS\(4)) # (!\C1|LessThan5~5_cout\))))
...
-- Equation(s):
-- \C1|LessThan5~9_cout\ = CARRY((\C1|Add2~4_combout\ & ((!\C1|LessThan5~7_cout\) # (!\C1|HPOS\(5)))) # (!\C1|Add2~4_combout\ & (!\C1|HPOS\(5) & !\C1|LessThan5~7_cout\)))
...
-- Equation(s):
-- \C1|LessThan5~11_cout\ = CARRY((\C1|Add2~6_combout\ & (\C1|HPOS\(6) & !\C1|LessThan5~9_cout\)) # (!\C1|Add2~6_combout\ & ((\C1|HPOS\(6)) # (!\C1|LessThan5~9_cout\))))
...
-- Equation(s):
-- \C1|LessThan5~13_cout\ = CARRY((\C1|Add2~8_combout\ & ((!\C1|LessThan5~11_cout\) # (!\C1|HPOS\(7)))) # (!\C1|Add2~8_combout\ & (!\C1|HPOS\(7) & !\C1|LessThan5~11_cout\)))
...
-- Equation(s):
-- \C1|LessThan5~15_cout\ = CARRY((\C1|HPOS\(8) & ((!\C1|LessThan5~13_cout\) # (!\C1|Add2~10_combout\))) # (!\C1|HPOS\(8) & (!\C1|Add2~10_combout\ & !\C1|LessThan5~13_cout\)))
...
-- Equation(s):
-- \C1|LessThan5~17_cout\ = CARRY((\C1|HPOS\(9) & (\C1|Add2~12_combout\ & !\C1|LessThan5~15_cout\)) # (!\C1|HPOS\(9) & ((\C1|Add2~12_combout\) # (!\C1|LessThan5~15_cout\))))
...
-- Equation(s):
-- \C1|LessThan5~18_combout\ = (\C1|Add2~14_combout\ & ((\C1|LessThan5~17_cout\) # (!\C1|HPOS\(10)))) # (!\C1|Add2~14_combout\ & (!\C1|HPOS\(10) & \C1|LessThan5~17_cout\))
...
-- Equation(s):
-- \C1|SQ_X2[3]~4_combout\ = !\C1|Add10~4_combout\
...
\C1|Add3~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \C1|Add3~1_cout\ = CARRY(\C1|SQ_Y2\(1))
...
-- Equation(s):
-- \C1|Add3~6_combout\ = (\C1|SQ_Y2\(4) & (!\C1|Add3~5\)) # (!\C1|SQ_Y2\(4) & (\C1|Add3~5\ & VCC))
-- \C1|Add3~7\ = CARRY((\C1|SQ_Y2\(4) & !\C1|Add3~5\))
...
-- Equation(s):
-- \C1|Add3~12_combout\ = (\C1|SQ_Y2\(7) & (\C1|Add3~11\ $ (GND))) # (!\C1|SQ_Y2\(7) & (!\C1|Add3~11\ & VCC))
...
-- Equation(s):
-- \C1|Add3~14_combout\ = (\C1|SQ_Y2\(8) & (!\C1|Add3~13\)) # (!\C1|SQ_Y2\(8) & ((\C1|Add3~13\) # (GND)))
-- \C1|Add3~15\ = CARRY((!\C1|Add3~13\) # (!\C1|SQ_Y2\(8)))
...
-- Equation(s):
-- \C1|DRAW2~0_combout\ = (\C1|LessThan4~20_combout\ & ((\C1|Add3~20_combout\) # (\C1|LessThan7~18_combout\)))
...
-- Equation(s):
-- \C1|DRAW2~1_combout\ = (\C1|LessThan6~20_combout\ & (\C1|DRAW2~0_combout\ & ((\C1|Add2~16_combout\) # (\C1|LessThan5~18_combout\))))
...
-- Equation(s):
-- \C1|process_0~5_combout\ = (!\C1|VPOS\(8) & (!\C1|VPOS\(9) & (!\C1|VPOS\(7) & !\C1|VPOS\(6))))
...
-- Equation(s):
-- \C1|LessThan8~1_combout\ = ((\C1|VPOS\(5)) # ((\C1|LessThan8~0_combout\ & \C1|VPOS\(4)))) # (!\C1|process_0~5_combout\)
...
-- Equation(s):
-- \C1|LessThan8~2_combout\ = (\C1|VPOS\(10) & \C1|LessThan8~1_combout\)
...
-- Equation(s):
-- \C1|Add9~0_combout\ = \C1|SQ_Y1\(1) $ (VCC)
-- \C1|Add9~1\ = CARRY(\C1|SQ_Y1\(1))
...
-- Equation(s):
-- \C1|Add9~2_combout\ = (\KEY~combout\(3) & ((\C1|SQ_Y1\(2) & (!\C1|Add9~1\)) # (!\C1|SQ_Y1\(2) & (\C1|Add9~1\ & VCC)))) # (!\KEY~combout\(3) & ((\C1|SQ_Y1\(2) & ((\C1|Add9~1\) # (GND))) # (!\C1|SQ_Y1\(2) & (!\C1|Add9~1\))))
-- \C1|Add9~3\ = CARRY((\KEY~combout\(3) & (\C1|SQ_Y1\(2) & !\C1|Add9~1\)) # (!\KEY~combout\(3) & ((\C1|SQ_Y1\(2)) # (!\C1|Add9~1\))))
...
-- Equation(s):
-- \C1|SQ_Y1[2]~7_combout\ = !\C1|Add9~2_combout\
...
-- Equation(s):
-- \C1|SQ_Y1[1]~1_combout\ = (\SW~combout\(0) & (\C1|SQ_Y1[1]~0_combout\ & (\C1|LessThan10~0_combout\ & \C1|LessThan9~1_combout\)))
...
-- Equation(s):
-- \C1|Add9~4_combout\ = ((\KEY~combout\(3) $ (\C1|SQ_Y1\(3) $ (!\C1|Add9~3\)))) # (GND)
-- \C1|Add9~5\ = CARRY((\KEY~combout\(3) & ((\C1|SQ_Y1\(3)) # (!\C1|Add9~3\))) # (!\KEY~combout\(3) & (\C1|SQ_Y1\(3) & !\C1|Add9~3\)))
...
-- Equation(s):
-- \C1|Add9~6_combout\ = (\KEY~combout\(3) & ((\C1|SQ_Y1\(4) & (!\C1|Add9~5\)) # (!\C1|SQ_Y1\(4) & (\C1|Add9~5\ & VCC)))) # (!\KEY~combout\(3) & ((\C1|SQ_Y1\(4) & ((\C1|Add9~5\) # (GND))) # (!\C1|SQ_Y1\(4) & (!\C1|Add9~5\))))
-- \C1|Add9~7\ = CARRY((\KEY~combout\(3) & (\C1|SQ_Y1\(4) & !\C1|Add9~5\)) # (!\KEY~combout\(3) & ((\C1|SQ_Y1\(4)) # (!\C1|Add9~5\))))
...
-- Equation(s):
-- \C1|SQ_Y1[4]~6_combout\ = !\C1|Add9~6_combout\
...
-- Equation(s):
-- \C1|Add9~8_combout\ = ((\KEY~combout\(3) $ (\C1|SQ_Y1\(5) $ (\C1|Add9~7\)))) # (GND)
-- \C1|Add9~9\ = CARRY((\KEY~combout\(3) & ((!\C1|Add9~7\) # (!\C1|SQ_Y1\(5)))) # (!\KEY~combout\(3) & (!\C1|SQ_Y1\(5) & !\C1|Add9~7\)))
...
-- Equation(s):
-- \C1|SQ_Y1[5]~5_combout\ = !\C1|Add9~8_combout\
...
-- Equation(s):
-- \C1|Add9~10_combout\ = (\KEY~combout\(3) & ((\C1|SQ_Y1\(6) & (!\C1|Add9~9\)) # (!\C1|SQ_Y1\(6) & (\C1|Add9~9\ & VCC)))) # (!\KEY~combout\(3) & ((\C1|SQ_Y1\(6) & ((\C1|Add9~9\) # (GND))) # (!\C1|SQ_Y1\(6) & (!\C1|Add9~9\))))
-- \C1|Add9~11\ = CARRY((\KEY~combout\(3) & (\C1|SQ_Y1\(6) & !\C1|Add9~9\)) # (!\KEY~combout\(3) & ((\C1|SQ_Y1\(6)) # (!\C1|Add9~9\))))
...
-- Equation(s):
-- \C1|SQ_Y1[6]~4_combout\ = !\C1|Add9~10_combout\
...
-- Equation(s):
-- \C1|Add9~12_combout\ = ((\KEY~combout\(3) $ (\C1|SQ_Y1\(7) $ (\C1|Add9~11\)))) # (GND)
-- \C1|Add9~13\ = CARRY((\KEY~combout\(3) & ((!\C1|Add9~11\) # (!\C1|SQ_Y1\(7)))) # (!\KEY~combout\(3) & (!\C1|SQ_Y1\(7) & !\C1|Add9~11\)))
...
-- Equation(s):
-- \C1|SQ_Y1[7]~3_combout\ = !\C1|Add9~12_combout\
...
-- Equation(s):
-- \C1|Add9~14_combout\ = (\KEY~combout\(3) & ((\C1|SQ_Y1\(8) & (!\C1|Add9~13\)) # (!\C1|SQ_Y1\(8) & (\C1|Add9~13\ & VCC)))) # (!\KEY~combout\(3) & ((\C1|SQ_Y1\(8) & ((\C1|Add9~13\) # (GND))) # (!\C1|SQ_Y1\(8) & (!\C1|Add9~13\))))
-- \C1|Add9~15\ = CARRY((\KEY~combout\(3) & (\C1|SQ_Y1\(8) & !\C1|Add9~13\)) # (!\KEY~combout\(3) & ((\C1|SQ_Y1\(8)) # (!\C1|Add9~13\))))
...
-- Equation(s):
-- \C1|SQ_Y1[8]~2_combout\ = !\C1|Add9~14_combout\
...
-- Equation(s):
-- \C1|Add9~16_combout\ = ((\KEY~combout\(3) $ (\C1|SQ_Y1\(9) $ (!\C1|Add9~15\)))) # (GND)
-- \C1|Add9~17\ = CARRY((\KEY~combout\(3) & ((\C1|SQ_Y1\(9)) # (!\C1|Add9~15\))) # (!\KEY~combout\(3) & (\C1|SQ_Y1\(9) & !\C1|Add9~15\)))
...
-- Equation(s):
-- \C1|Add9~18_combout\ = \C1|SQ_Y1\(10) $ (\C1|Add9~17\ $ (\KEY~combout\(3)))
...
-- Equation(s):
-- \C1|Add6~0_combout\ = \C1|SQ_X1\(1) $ (VCC)
-- \C1|Add6~1\ = CARRY(\C1|SQ_X1\(1))
...
-- Equation(s):
-- \C1|SQ_X1[1]~1_combout\ = (\SW~combout\(0) & (\C1|SQ_X1[1]~0_combout\ & (\C1|LessThan10~0_combout\ & \C1|LessThan9~1_combout\)))
...
-- Equation(s):
-- \C1|Add6~2_combout\ = (\KEY~combout\(1) & ((\C1|SQ_X1\(2) & ((\C1|Add6~1\) # (GND))) # (!\C1|SQ_X1\(2) & (!\C1|Add6~1\)))) # (!\KEY~combout\(1) & ((\C1|SQ_X1\(2) & (!\C1|Add6~1\)) # (!\C1|SQ_X1\(2) & (\C1|Add6~1\ & VCC))))
-- \C1|Add6~3\ = CARRY((\KEY~combout\(1) & ((\C1|SQ_X1\(2)) # (!\C1|Add6~1\))) # (!\KEY~combout\(1) & (\C1|SQ_X1\(2) & !\C1|Add6~1\)))
...
-- Equation(s):
-- \C1|SQ_X1[2]~7_combout\ = !\C1|Add6~2_combout\
...
-- Equation(s):
-- \C1|Add6~4_combout\ = ((\KEY~combout\(1) $ (\C1|SQ_X1\(3) $ (\C1|Add6~3\)))) # (GND)
-- \C1|Add6~5\ = CARRY((\KEY~combout\(1) & (\C1|SQ_X1\(3) & !\C1|Add6~3\)) # (!\KEY~combout\(1) & ((\C1|SQ_X1\(3)) # (!\C1|Add6~3\))))
...
-- Equation(s):
-- \C1|Add6~6_combout\ = (\KEY~combout\(1) & ((\C1|SQ_X1\(4) & ((\C1|Add6~5\) # (GND))) # (!\C1|SQ_X1\(4) & (!\C1|Add6~5\)))) # (!\KEY~combout\(1) & ((\C1|SQ_X1\(4) & (!\C1|Add6~5\)) # (!\C1|SQ_X1\(4) & (\C1|Add6~5\ & VCC))))
-- \C1|Add6~7\ = CARRY((\KEY~combout\(1) & ((\C1|SQ_X1\(4)) # (!\C1|Add6~5\))) # (!\KEY~combout\(1) & (\C1|SQ_X1\(4) & !\C1|Add6~5\)))
...
-- Equation(s):
-- \C1|SQ_X1[4]~6_combout\ = !\C1|Add6~6_combout\
...
-- Equation(s):
-- \C1|Add6~8_combout\ = ((\KEY~combout\(1) $ (\C1|SQ_X1\(5) $ (!\C1|Add6~7\)))) # (GND)
-- \C1|Add6~9\ = CARRY((\KEY~combout\(1) & (!\C1|SQ_X1\(5) & !\C1|Add6~7\)) # (!\KEY~combout\(1) & ((!\C1|Add6~7\) # (!\C1|SQ_X1\(5)))))
...
-- Equation(s):
-- \C1|SQ_X1[5]~5_combout\ = !\C1|Add6~8_combout\
...
-- Equation(s):
-- \C1|Add6~10_combout\ = (\KEY~combout\(1) & ((\C1|SQ_X1\(6) & ((\C1|Add6~9\) # (GND))) # (!\C1|SQ_X1\(6) & (!\C1|Add6~9\)))) # (!\KEY~combout\(1) & ((\C1|SQ_X1\(6) & (!\C1|Add6~9\)) # (!\C1|SQ_X1\(6) & (\C1|Add6~9\ & VCC))))
-- \C1|Add6~11\ = CARRY((\KEY~combout\(1) & ((\C1|SQ_X1\(6)) # (!\C1|Add6~9\))) # (!\KEY~combout\(1) & (\C1|SQ_X1\(6) & !\C1|Add6~9\)))
...
-- Equation(s):
-- \C1|SQ_X1[6]~4_combout\ = !\C1|Add6~10_combout\
...
-- Equation(s):
-- \C1|Add6~12_combout\ = ((\KEY~combout\(1) $ (\C1|SQ_X1\(7) $ (!\C1|Add6~11\)))) # (GND)
-- \C1|Add6~13\ = CARRY((\KEY~combout\(1) & (!\C1|SQ_X1\(7) & !\C1|Add6~11\)) # (!\KEY~combout\(1) & ((!\C1|Add6~11\) # (!\C1|SQ_X1\(7)))))
...
-- Equation(s):
-- \C1|SQ_X1[7]~3_combout\ = !\C1|Add6~12_combout\
...
-- Equation(s):
-- \C1|Add6~14_combout\ = (\KEY~combout\(1) & ((\C1|SQ_X1\(8) & ((\C1|Add6~13\) # (GND))) # (!\C1|SQ_X1\(8) & (!\C1|Add6~13\)))) # (!\KEY~combout\(1) & ((\C1|SQ_X1\(8) & (!\C1|Add6~13\)) # (!\C1|SQ_X1\(8) & (\C1|Add6~13\ & VCC))))
-- \C1|Add6~15\ = CARRY((\KEY~combout\(1) & ((\C1|SQ_X1\(8)) # (!\C1|Add6~13\))) # (!\KEY~combout\(1) & (\C1|SQ_X1\(8) & !\C1|Add6~13\)))
...
-- Equation(s):
-- \C1|SQ_X1[8]~2_combout\ = !\C1|Add6~14_combout\
...
-- Equation(s):
-- \C1|Add6~16_combout\ = ((\KEY~combout\(1) $ (\C1|SQ_X1\(9) $ (\C1|Add6~15\)))) # (GND)
-- \C1|Add6~17\ = CARRY((\KEY~combout\(1) & (\C1|SQ_X1\(9) & !\C1|Add6~15\)) # (!\KEY~combout\(1) & ((\C1|SQ_X1\(9)) # (!\C1|Add6~15\))))
...
-- Equation(s):
-- \C1|Add6~18_combout\ = \KEY~combout\(1) $ (\C1|SQ_X1\(10) $ (!\C1|Add6~17\))
...
-- Equation(s):
-- \C1|DRAW1~0_combout\ = (\C1|Add1~20_combout\ & (((\C1|Add0~16_combout\) # (\C1|LessThan1~18_combout\)))) # (!\C1|Add1~20_combout\ & (\C1|LessThan3~18_combout\ & ((\C1|Add0~16_combout\) # (\C1|LessThan1~18_combout\))))
...
-- Equation(s):
-- \C1|R~0_combout\ = (\C1|B~0_combout\ & ((\C1|LessThan8~2_combout\) # ((\C1|DRAW2~1_combout\) # (\C1|DRAW1~1_combout\))))
...
-- Equation(s):
-- \C1|R~2_combout\ = (!\C1|DRAW2~1_combout\ & (\C1|LessThan2~20_combout\ & (\C1|LessThan0~20_combout\ & \C1|DRAW1~0_combout\)))
...
-- Equation(s):
-- \C1|B~1_combout\ = (\C1|DRAW2~1_combout\ & (!\SW~combout\(1))) # (!\C1|DRAW2~1_combout\ & ((\C1|DRAW1~1_combout\ & (!\SW~combout\(1))) # (!\C1|DRAW1~1_combout\ & ((\C1|LessThan8~2_combout\)))))
...
-- Equation(s):
-- \C1|process_0~10_combout\ = ((\C1|VPOS\(10)) # ((\C1|VPOS\(5) & !\C1|LessThan14~0_combout\))) # (!\C1|process_0~5_combout\)
...
\C1|LessThan17~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \C1|LessThan17~1_combout\ = (!\C1|VPOS\(5) & (\C1|LessThan17~0_combout\ & (!\C1|VPOS\(1) & !\C1|VPOS\(0))))
...
PORT MAP (
	...
	datac => \C1|VPOS\(1),
	datad => \C1|VPOS\(0),
	combout => \C1|LessThan17~1_combout\);

-- Location: LCCOMB_X30_Y17_N22
\C1|process_0~7\ : cycloneii_lcell_comb
-- Equation(s):
-- \C1|process_0~7_combout\ = (!\C1|HPOS\(5) & (\C1|process_0~1_combout\ & (!\C1|HPOS\(4) & !\C1|HPOS\(6))))
...
-- Equation(s):
-- \C1|process_0~8_combout\ = (\C1|HPOS\(8) & (!\C1|LessThan12~0_combout\ & (\C1|HPOS\(7)))) # (!\C1|HPOS\(8) & (((!\C1|HPOS\(7) & \C1|process_0~7_combout\))))
...
-- Equation(s):
-- \C1|process_0~9_combout\ = (\C1|HPOS\(10)) # ((\C1|HPOS\(9)) # (\C1|process_0~8_combout\))
...
-- Equation(s):
-- \C1|B~0_combout\ = (\C1|process_0~9_combout\ & ((\C1|process_0~10_combout\) # (\C1|LessThan17~1_combout\)))
...
-- Equation(s):
-- \C1|B~2_combout\ = (\C1|B~0_combout\ & ((\C1|R~2_combout\ & (!\SW~combout\(0))) # (!\C1|R~2_combout\ & ((\C1|B~1_combout\)))))
