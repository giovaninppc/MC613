...
SIGNAL \C1|LessThan16~2_combout\ : std_logic;
...
-- Equation(s):
-- \C1|Add9~18_combout\ = \KEY~combout\(3) $ (\C1|SQ_Y1\(10) $ (\C1|Add9~17\))
...
-- Equation(s):
-- \C1|Add6~4_combout\ = ((\C1|SQ_X1\(3) $ (\KEY~combout\(1) $ (\C1|Add6~3\)))) # (GND)
-- \C1|Add6~5\ = CARRY((\C1|SQ_X1\(3) & ((!\C1|Add6~3\) # (!\KEY~combout\(1)))) # (!\C1|SQ_X1\(3) & (!\KEY~combout\(1) & !\C1|Add6~3\)))
...
-- Equation(s):
-- \C1|LessThan16~0_combout\ = (!\C1|VPOS\(1) & !\C1|VPOS\(0))
...
-- Equation(s):
-- \C1|process_0~6_combout\ = (!\C1|HPOS\(6) & (!\C1|HPOS\(5) & (\C1|process_0~1_combout\ & !\C1|HPOS\(4))))
...
\C1|LessThan16~2\ : cycloneii_lcell_comb
-- Equation(s):
-- \C1|LessThan16~2_combout\ = (\C1|LessThan16~1_combout\ & (!\C1|VPOS\(0) & !\C1|VPOS\(1)))
...
PORT MAP (
	...
	datac => \C1|VPOS\(0),
	datad => \C1|VPOS\(1),
	combout => \C1|LessThan16~2_combout\);
...
-- Equation(s):
-- \C1|process_0~1_combout\ = (!\C1|HPOS\(3) & (!\C1|HPOS\(2) & (!\C1|HPOS\(0) & !\C1|HPOS\(1))))
...
-- Equation(s):
-- \C1|LessThan13~0_combout\ = ((!\C1|VPOS\(4) & (!\C1|VPOS\(1) & !\C1|VPOS\(2)))) # (!\C1|VPOS\(5))
...
-- Equation(s):
-- \C1|LessThan13~1_combout\ = (\C1|process_0~4_combout\ & ((\C1|LessThan13~0_combout\) # ((!\C1|VPOS\(3) & !\C1|VPOS\(4)))))
...
-- Equation(s):
-- \C1|LessThan9~0_combout\ = (\C1|VPOS\(10) & !\C1|LessThan13~1_combout\)
...
-- Equation(s):
-- \C1|LessThan16~1_combout\ = (!\C1|VPOS\(3) & (!\C1|VPOS\(4) & (!\C1|VPOS\(5) & !\C1|VPOS\(2))))
...
-- Equation(s):
-- \C1|SQ_Y2[1]~0_combout\ = (\C1|LessThan8~1_combout\ & (\C1|SQ_Y1[1]~0_combout\ & (\C1|LessThan9~0_combout\ & \SW~combout\(1))))
...
-- Equation(s):
-- \C1|Add13~4_combout\ = ((\KEY~combout\(3) $ (\C1|SQ_Y2\(3) $ (\C1|Add13~3\)))) # (GND)
-- \C1|Add13~5\ = CARRY((\KEY~combout\(3) & ((!\C1|Add13~3\) # (!\C1|SQ_Y2\(3)))) # (!\KEY~combout\(3) & (!\C1|SQ_Y2\(3) & !\C1|Add13~3\)))
...
-- Equation(s):
-- \C1|Add13~6_combout\ = (\KEY~combout\(3) & ((\C1|SQ_Y2\(4) & (!\C1|Add13~5\)) # (!\C1|SQ_Y2\(4) & (\C1|Add13~5\ & VCC)))) # (!\KEY~combout\(3) & ((\C1|SQ_Y2\(4) & ((\C1|Add13~5\) # (GND))) # (!\C1|SQ_Y2\(4) & (!\C1|Add13~5\))))
-- \C1|Add13~7\ = CARRY((\KEY~combout\(3) & (\C1|SQ_Y2\(4) & !\C1|Add13~5\)) # (!\KEY~combout\(3) & ((\C1|SQ_Y2\(4)) # (!\C1|Add13~5\))))
...
-- Equation(s):
-- \C1|Add13~8_combout\ = ((\KEY~combout\(3) $ (\C1|SQ_Y2\(5) $ (!\C1|Add13~7\)))) # (GND)
-- \C1|Add13~9\ = CARRY((\KEY~combout\(3) & ((\C1|SQ_Y2\(5)) # (!\C1|Add13~7\))) # (!\KEY~combout\(3) & (\C1|SQ_Y2\(5) & !\C1|Add13~7\)))
...
-- Equation(s):
-- \C1|Add13~10_combout\ = (\KEY~combout\(3) & ((\C1|SQ_Y2\(6) & (!\C1|Add13~9\)) # (!\C1|SQ_Y2\(6) & (\C1|Add13~9\ & VCC)))) # (!\KEY~combout\(3) & ((\C1|SQ_Y2\(6) & ((\C1|Add13~9\) # (GND))) # (!\C1|SQ_Y2\(6) & (!\C1|Add13~9\))))
-- \C1|Add13~11\ = CARRY((\KEY~combout\(3) & (\C1|SQ_Y2\(6) & !\C1|Add13~9\)) # (!\KEY~combout\(3) & ((\C1|SQ_Y2\(6)) # (!\C1|Add13~9\))))
...
-- Equation(s):
-- \C1|Add13~12_combout\ = ((\KEY~combout\(3) $ (\C1|SQ_Y2\(7) $ (!\C1|Add13~11\)))) # (GND)
-- \C1|Add13~13\ = CARRY((\KEY~combout\(3) & ((\C1|SQ_Y2\(7)) # (!\C1|Add13~11\))) # (!\KEY~combout\(3) & (\C1|SQ_Y2\(7) & !\C1|Add13~11\)))
...
-- Equation(s):
-- \C1|Add13~14_combout\ = (\KEY~combout\(3) & ((\C1|SQ_Y2\(8) & (\C1|Add13~13\ & VCC)) # (!\C1|SQ_Y2\(8) & (!\C1|Add13~13\)))) # (!\KEY~combout\(3) & ((\C1|SQ_Y2\(8) & (!\C1|Add13~13\)) # (!\C1|SQ_Y2\(8) & ((\C1|Add13~13\) # (GND)))))
-- \C1|Add13~15\ = CARRY((\KEY~combout\(3) & (!\C1|SQ_Y2\(8) & !\C1|Add13~13\)) # (!\KEY~combout\(3) & ((!\C1|Add13~13\) # (!\C1|SQ_Y2\(8)))))
...
-- Equation(s):
-- \C1|Add13~16_combout\ = ((\KEY~combout\(3) $ (\C1|SQ_Y2\(9) $ (\C1|Add13~15\)))) # (GND)
-- \C1|Add13~17\ = CARRY((\KEY~combout\(3) & ((!\C1|Add13~15\) # (!\C1|SQ_Y2\(9)))) # (!\KEY~combout\(3) & (!\C1|SQ_Y2\(9) & !\C1|Add13~15\)))
...
-- Equation(s):
-- \C1|Add13~18_combout\ = \KEY~combout\(3) $ (\C1|SQ_Y2\(10) $ (\C1|Add13~17\))
...
-- Equation(s):
-- \C1|Add10~18_combout\ = \KEY~combout\(1) $ (\C1|Add10~17\ $ (!\C1|SQ_X2\(10)))
...
-- Equation(s):
-- \C1|SQ_X1[1]~0_combout\ = (!\KEY~combout\(1)) # (!\KEY~combout\(0))
...
-- Equation(s):
-- \C1|SQ_X2[1]~0_combout\ = (\C1|LessThan8~1_combout\ & (\SW~combout\(1) & (\C1|SQ_X1[1]~0_combout\ & \C1|LessThan9~0_combout\)))
...
-- Equation(s):
-- \C1|LessThan5~5_cout\ = CARRY((\C1|HPOS\(3) & (\C1|Add2~0_combout\ & !\C1|LessThan5~3_cout\)) # (!\C1|HPOS\(3) & ((\C1|Add2~0_combout\) # (!\C1|LessThan5~3_cout\))))
...
-- Equation(s):
-- \C1|LessThan5~7_cout\ = CARRY((\C1|HPOS\(4) & ((!\C1|LessThan5~5_cout\) # (!\C1|Add2~2_combout\))) # (!\C1|HPOS\(4) & (!\C1|Add2~2_combout\ & !\C1|LessThan5~5_cout\)))
...
-- Equation(s):
-- \C1|LessThan5~11_cout\ = CARRY((\C1|HPOS\(6) & ((!\C1|LessThan5~9_cout\) # (!\C1|Add2~6_combout\))) # (!\C1|HPOS\(6) & (!\C1|Add2~6_combout\ & !\C1|LessThan5~9_cout\)))
...
-- Equation(s):
-- \C1|LessThan5~13_cout\ = CARRY((\C1|HPOS\(7) & (\C1|Add2~8_combout\ & !\C1|LessThan5~11_cout\)) # (!\C1|HPOS\(7) & ((\C1|Add2~8_combout\) # (!\C1|LessThan5~11_cout\))))
...
-- Equation(s):
-- \C1|LessThan5~18_combout\ = (\C1|Add2~14_combout\ & ((\C1|LessThan5~17_cout\) # (!\C1|HPOS\(10)))) # (!\C1|Add2~14_combout\ & (\C1|LessThan5~17_cout\ & !\C1|HPOS\(10)))
...
-- Equation(s):
-- \C1|B~0_combout\ = (\C1|process_0~8_combout\ & ((\C1|LessThan16~2_combout\) # ((\C1|VPOS\(10)) # (!\C1|LessThan13~1_combout\))))
...
-- Equation(s):
-- \C1|SQ_X1[1]~1_combout\ = (\C1|LessThan8~1_combout\ & (\SW~combout\(0) & (\C1|SQ_X1[1]~0_combout\ & \C1|LessThan9~0_combout\)))
...
-- Equation(s):
-- \C1|Add6~2_combout\ = (\C1|SQ_X1\(2) & ((\KEY~combout\(1) & ((\C1|Add6~1\) # (GND))) # (!\KEY~combout\(1) & (!\C1|Add6~1\)))) # (!\C1|SQ_X1\(2) & ((\KEY~combout\(1) & (!\C1|Add6~1\)) # (!\KEY~combout\(1) & (\C1|Add6~1\ & VCC))))
-- \C1|Add6~3\ = CARRY((\C1|SQ_X1\(2) & ((\KEY~combout\(1)) # (!\C1|Add6~1\))) # (!\C1|SQ_X1\(2) & (\KEY~combout\(1) & !\C1|Add6~1\)))
...
-- Equation(s):
-- \C1|Add6~6_combout\ = (\C1|SQ_X1\(4) & ((\KEY~combout\(1) & ((\C1|Add6~5\) # (GND))) # (!\KEY~combout\(1) & (!\C1|Add6~5\)))) # (!\C1|SQ_X1\(4) & ((\KEY~combout\(1) & (!\C1|Add6~5\)) # (!\KEY~combout\(1) & (\C1|Add6~5\ & VCC))))
-- \C1|Add6~7\ = CARRY((\C1|SQ_X1\(4) & ((\KEY~combout\(1)) # (!\C1|Add6~5\))) # (!\C1|SQ_X1\(4) & (\KEY~combout\(1) & !\C1|Add6~5\)))
...
-- Equation(s):
-- \C1|Add6~8_combout\ = ((\C1|SQ_X1\(5) $ (\KEY~combout\(1) $ (!\C1|Add6~7\)))) # (GND)
-- \C1|Add6~9\ = CARRY((\C1|SQ_X1\(5) & (!\KEY~combout\(1) & !\C1|Add6~7\)) # (!\C1|SQ_X1\(5) & ((!\C1|Add6~7\) # (!\KEY~combout\(1)))))
...
-- Equation(s):
-- \C1|Add6~10_combout\ = (\C1|SQ_X1\(6) & ((\KEY~combout\(1) & ((\C1|Add6~9\) # (GND))) # (!\KEY~combout\(1) & (!\C1|Add6~9\)))) # (!\C1|SQ_X1\(6) & ((\KEY~combout\(1) & (!\C1|Add6~9\)) # (!\KEY~combout\(1) & (\C1|Add6~9\ & VCC))))
-- \C1|Add6~11\ = CARRY((\C1|SQ_X1\(6) & ((\KEY~combout\(1)) # (!\C1|Add6~9\))) # (!\C1|SQ_X1\(6) & (\KEY~combout\(1) & !\C1|Add6~9\)))
...
-- Equation(s):
-- \C1|Add6~12_combout\ = ((\C1|SQ_X1\(7) $ (\KEY~combout\(1) $ (!\C1|Add6~11\)))) # (GND)
-- \C1|Add6~13\ = CARRY((\C1|SQ_X1\(7) & (!\KEY~combout\(1) & !\C1|Add6~11\)) # (!\C1|SQ_X1\(7) & ((!\C1|Add6~11\) # (!\KEY~combout\(1)))))
...
-- Equation(s):
-- \C1|Add6~14_combout\ = (\C1|SQ_X1\(8) & ((\KEY~combout\(1) & ((\C1|Add6~13\) # (GND))) # (!\KEY~combout\(1) & (!\C1|Add6~13\)))) # (!\C1|SQ_X1\(8) & ((\KEY~combout\(1) & (!\C1|Add6~13\)) # (!\KEY~combout\(1) & (\C1|Add6~13\ & VCC))))
-- \C1|Add6~15\ = CARRY((\C1|SQ_X1\(8) & ((\KEY~combout\(1)) # (!\C1|Add6~13\))) # (!\C1|SQ_X1\(8) & (\KEY~combout\(1) & !\C1|Add6~13\)))
...
-- Equation(s):
-- \C1|Add6~16_combout\ = ((\C1|SQ_X1\(9) $ (\KEY~combout\(1) $ (\C1|Add6~15\)))) # (GND)
-- \C1|Add6~17\ = CARRY((\C1|SQ_X1\(9) & ((!\C1|Add6~15\) # (!\KEY~combout\(1)))) # (!\C1|SQ_X1\(9) & (!\KEY~combout\(1) & !\C1|Add6~15\)))
...
-- Equation(s):
-- \C1|Add6~18_combout\ = \C1|SQ_X1\(10) $ (\C1|Add6~17\ $ (!\KEY~combout\(1)))
...
-- Equation(s):
-- \C1|LessThan1~3_cout\ = CARRY((\C1|HPOS\(2) & ((!\C1|LessThan1~1_cout\) # (!\C1|SQ_X1\(2)))) # (!\C1|HPOS\(2) & (!\C1|SQ_X1\(2) & !\C1|LessThan1~1_cout\)))
...
-- Equation(s):
-- \C1|LessThan1~11_cout\ = CARRY((\C1|Add0~6_combout\ & (\C1|HPOS\(6) & !\C1|LessThan1~9_cout\)) # (!\C1|Add0~6_combout\ & ((\C1|HPOS\(6)) # (!\C1|LessThan1~9_cout\))))
...
-- Equation(s):
-- \C1|LessThan1~13_cout\ = CARRY((\C1|HPOS\(7) & (\C1|Add0~8_combout\ & !\C1|LessThan1~11_cout\)) # (!\C1|HPOS\(7) & ((\C1|Add0~8_combout\) # (!\C1|LessThan1~11_cout\))))
...
-- Equation(s):
-- \C1|LessThan1~15_cout\ = CARRY((\C1|Add0~10_combout\ & (\C1|HPOS\(8) & !\C1|LessThan1~13_cout\)) # (!\C1|Add0~10_combout\ & ((\C1|HPOS\(8)) # (!\C1|LessThan1~13_cout\))))
...
-- Equation(s):
-- \C1|SQ_Y1[1]~1_combout\ = (\C1|LessThan8~1_combout\ & (\C1|SQ_Y1[1]~0_combout\ & (\C1|LessThan9~0_combout\ & \SW~combout\(0))))
...
-- Equation(s):
-- \C1|DRAW1~0_combout\ = (\C1|LessThan3~18_combout\ & ((\C1|LessThan1~18_combout\) # ((\C1|Add0~16_combout\)))) # (!\C1|LessThan3~18_combout\ & (\C1|Add1~20_combout\ & ((\C1|LessThan1~18_combout\) # (\C1|Add0~16_combout\))))
...
-- Equation(s):
-- \C1|R~0_combout\ = (\C1|B~0_combout\ & ((\C1|DRAW2~1_combout\ & (!\SW~combout\(1))) # (!\C1|DRAW2~1_combout\ & ((\C1|DRAW1~1_combout\)))))
...
-- Equation(s):
-- \C1|B~1_combout\ = (\C1|LessThan2~20_combout\ & (!\SW~combout\(0) & (\C1|LessThan0~20_combout\ & \C1|DRAW1~0_combout\)))
...
-- Equation(s):
-- \C1|G~0_combout\ = (\C1|B~0_combout\ & ((\C1|DRAW2~1_combout\) # (\C1|B~1_combout\)))
