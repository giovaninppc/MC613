...
-- Equation(s):
-- \C1|LessThan17~1_combout\ = (!\C1|VPOS\(4) & (((!\C1|VPOS\(2) & !\C1|VPOS\(1))) # (!\C1|VPOS\(3))))
...
-- Equation(s):
-- \C1|process_0~10_combout\ = (!\C1|HPOS\(4) & (!\C1|HPOS\(6) & (!\C1|HPOS\(5) & !\C1|HPOS\(7))))
...
-- Equation(s):
-- \C1|process_0~11_combout\ = (\C1|process_0~10_combout\ & (!\C1|HPOS\(8) & \C1|process_0~2_combout\))
...
-- Equation(s):
-- \C1|LessThan9~0_combout\ = (!\C1|VPOS\(5) & (((!\C1|VPOS\(4)) # (!\C1|VPOS\(3))) # (!\C1|VPOS\(2))))
...
-- Equation(s):
-- \C1|R~3_combout\ = (!\C1|HPOS\(9) & (!\C1|HPOS\(10) & ((\C1|LessThan9~0_combout\) # (!\C1|VPOS\(6)))))
...
-- Equation(s):
-- \C1|LessThan11~0_combout\ = (!\C1|HPOS\(9)) # (!\C1|HPOS\(10))
...
-- Equation(s):
-- \C1|LessThan16~0_combout\ = (!\C1|HPOS\(5) & (!\C1|HPOS\(6) & ((!\C1|HPOS\(3)) # (!\C1|HPOS\(4)))))
...
-- Equation(s):
-- \C1|LessThan11~1_combout\ = (!\C1|LessThan11~0_combout\ & ((\C1|HPOS\(8)) # ((\C1|HPOS\(7) & !\C1|LessThan16~0_combout\))))
...
-- Equation(s):
-- \C1|process_0~3_combout\ = (\C1|HPOS\(5) & ((\C1|HPOS\(4)) # (\C1|HPOS\(7))))
...
-- Equation(s):
-- \C1|process_0~2_combout\ = (!\C1|HPOS\(2) & (!\C1|HPOS\(0) & (!\C1|HPOS\(1) & !\C1|HPOS\(3))))
...
-- Equation(s):
-- \C1|process_0~4_combout\ = (\C1|HPOS\(7) & (!\C1|process_0~3_combout\ & (!\C1|HPOS\(6)))) # (!\C1|HPOS\(7) & ((\C1|HPOS\(6)) # ((\C1|process_0~3_combout\ & !\C1|process_0~2_combout\))))
...
-- Equation(s):
-- \C1|process_0~13_combout\ = (\C1|HPOS\(10)) # ((\C1|HPOS\(9)) # ((\C1|HPOS\(8)) # (!\C1|process_0~4_combout\)))
...
PORT MAP (
	clk => \C|altpll_0|sd1|_clk0~clkctrl_outclk\,
	datain => \C1|process_0~13_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \C1|LessThan17~0_combout\ = (!\C1|VPOS\(6) & (!\C1|VPOS\(7) & (!\C1|VPOS\(8) & !\C1|VPOS\(9))))
...
-- Equation(s):
-- \C1|LessThan12~0_combout\ = (\C1|VPOS\(10) & (((!\C1|LessThan17~1_combout\ & \C1|VPOS\(5))) # (!\C1|LessThan17~0_combout\)))
...
-- Equation(s):
-- \C1|process_0~6_combout\ = (\C1|VPOS\(10)) # (\C1|VPOS\(3))
...
-- Equation(s):
-- \C1|process_0~5_combout\ = (\C1|VPOS\(2)) # ((\C1|VPOS\(4)) # ((!\C1|VPOS\(0) & !\C1|VPOS\(1))))
...
-- Equation(s):
-- \C1|process_0~7_combout\ = (\C1|VPOS\(5)) # ((\C1|process_0~6_combout\) # ((\C1|process_0~5_combout\) # (!\C1|LessThan17~0_combout\)))
...
-- Equation(s):
-- \C1|LessThan8~1_combout\ = (!\C1|HPOS\(4) & (((!\C1|HPOS\(1) & !\C1|HPOS\(2))) # (!\C1|HPOS\(3))))
...
-- Equation(s):
-- \C1|R~1_combout\ = (!\C1|VPOS\(10) & (!\C1|VPOS\(8) & (!\C1|VPOS\(7) & !\C1|VPOS\(9))))
...
-- Equation(s):
-- \C1|LessThan8~0_combout\ = ((!\C1|HPOS\(6)) # (!\C1|HPOS\(7))) # (!\C1|HPOS\(8))
...
-- Equation(s):
-- \C1|R~2_combout\ = (\C1|R~1_combout\ & ((\C1|LessThan8~0_combout\) # ((!\C1|HPOS\(5) & \C1|LessThan8~1_combout\))))
...
-- Equation(s):
-- \C1|R~4_combout\ = (\C1|VPOS\(3) & ((\C1|VPOS\(2)) # ((\C1|VPOS\(0) & \C1|VPOS\(1)))))
...
-- Equation(s):
-- \C1|R~5_combout\ = (\C1|VPOS\(5)) # (((\C1|R~4_combout\ & \C1|VPOS\(4))) # (!\C1|LessThan17~0_combout\))
...
-- Equation(s):
-- \C1|R~6_combout\ = (\C1|R~3_combout\ & ((\C1|R~2_combout\) # ((\C1|VPOS\(10) & \C1|R~5_combout\)))) # (!\C1|R~3_combout\ & (\C1|VPOS\(10) & ((\C1|R~5_combout\))))
...
-- Equation(s):
-- \C1|LessThan14~0_combout\ = (\C1|SQ_Y2\(5)) # (((\C1|SQ_Y2\(7)) # (!\C1|SQ_Y2\(4))) # (!\C1|SQ_Y2\(6)))
...
-- Equation(s):
-- \C1|LessThan14~1_combout\ = ((\C1|LessThan14~0_combout\) # (\C1|SQ_Y2\(8))) # (!\C1|SQ_Y2\(9))
...
-- Equation(s):
-- \C1|SQ_Y2[1]~2_combout\ = (\C1|LessThan11~1_combout\ & (\C1|LessThan12~0_combout\ & ((!\C1|SQ_Y2[8]~1_combout\) # (!\C1|LessThan14~1_combout\))))
...
-- Equation(s):
-- \C1|Add9~4_combout\ = ((\C1|SQ_Y2[8]~0_combout\ $ (\C1|SQ_Y2\(3) $ (!\C1|Add9~3\)))) # (GND)
-- \C1|Add9~5\ = CARRY((\C1|SQ_Y2[8]~0_combout\ & (!\C1|SQ_Y2\(3) & !\C1|Add9~3\)) # (!\C1|SQ_Y2[8]~0_combout\ & ((!\C1|Add9~3\) # (!\C1|SQ_Y2\(3)))))
...
-- Equation(s):
-- \C1|Add9~6_combout\ = (\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(4) & ((\C1|Add9~5\) # (GND))) # (!\C1|SQ_Y2\(4) & (!\C1|Add9~5\)))) # (!\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(4) & (!\C1|Add9~5\)) # (!\C1|SQ_Y2\(4) & (\C1|Add9~5\ & VCC))))
-- \C1|Add9~7\ = CARRY((\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(4)) # (!\C1|Add9~5\))) # (!\C1|SQ_Y2[8]~0_combout\ & (\C1|SQ_Y2\(4) & !\C1|Add9~5\)))
...
-- Equation(s):
-- \C1|Add9~8_combout\ = ((\C1|SQ_Y2[8]~0_combout\ $ (\C1|SQ_Y2\(5) $ (\C1|Add9~7\)))) # (GND)
-- \C1|Add9~9\ = CARRY((\C1|SQ_Y2[8]~0_combout\ & (\C1|SQ_Y2\(5) & !\C1|Add9~7\)) # (!\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(5)) # (!\C1|Add9~7\))))
...
-- Equation(s):
-- \C1|Add9~10_combout\ = (\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(6) & ((\C1|Add9~9\) # (GND))) # (!\C1|SQ_Y2\(6) & (!\C1|Add9~9\)))) # (!\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(6) & (!\C1|Add9~9\)) # (!\C1|SQ_Y2\(6) & (\C1|Add9~9\ & VCC))))
-- \C1|Add9~11\ = CARRY((\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(6)) # (!\C1|Add9~9\))) # (!\C1|SQ_Y2[8]~0_combout\ & (\C1|SQ_Y2\(6) & !\C1|Add9~9\)))
...
-- Equation(s):
-- \C1|Add9~12_combout\ = ((\C1|SQ_Y2[8]~0_combout\ $ (\C1|SQ_Y2\(7) $ (\C1|Add9~11\)))) # (GND)
-- \C1|Add9~13\ = CARRY((\C1|SQ_Y2[8]~0_combout\ & (\C1|SQ_Y2\(7) & !\C1|Add9~11\)) # (!\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(7)) # (!\C1|Add9~11\))))
...
-- Equation(s):
-- \C1|Add9~14_combout\ = (\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(8) & (!\C1|Add9~13\)) # (!\C1|SQ_Y2\(8) & ((\C1|Add9~13\) # (GND))))) # (!\C1|SQ_Y2[8]~0_combout\ & ((\C1|SQ_Y2\(8) & (\C1|Add9~13\ & VCC)) # (!\C1|SQ_Y2\(8) & (!\C1|Add9~13\))))
-- \C1|Add9~15\ = CARRY((\C1|SQ_Y2[8]~0_combout\ & ((!\C1|Add9~13\) # (!\C1|SQ_Y2\(8)))) # (!\C1|SQ_Y2[8]~0_combout\ & (!\C1|SQ_Y2\(8) & !\C1|Add9~13\)))
...
-- Equation(s):
-- \C1|Add9~18_combout\ = \C1|SQ_Y2\(10) $ (\C1|Add9~17\ $ (!\C1|SQ_Y2[8]~0_combout\))
...
-- Equation(s):
-- \C1|SQ_X2[1]~0_combout\ = (!\C1|SQ_X1[10]~0_combout\ & (\C1|LessThan12~0_combout\ & (\C1|LessThan11~1_combout\ & \SW~combout\(1))))
...
-- Equation(s):
-- \C1|LessThan7~3_cout\ = CARRY((\C1|Add3~0_combout\ & (\C1|VPOS\(2) & !\C1|LessThan7~1_cout\)) # (!\C1|Add3~0_combout\ & ((\C1|VPOS\(2)) # (!\C1|LessThan7~1_cout\))))
...
-- Equation(s):
-- \C1|LessThan7~11_cout\ = CARRY((\C1|Add3~8_combout\ & (\C1|VPOS\(6) & !\C1|LessThan7~9_cout\)) # (!\C1|Add3~8_combout\ & ((\C1|VPOS\(6)) # (!\C1|LessThan7~9_cout\))))
...
-- Equation(s):
-- \C1|Add13~18_combout\ = \KEY~combout\(1) $ (\C1|SQ_X2\(10) $ (!\C1|Add13~17\))
...
-- Equation(s):
-- \C1|LessThan5~13_cout\ = CARRY((\C1|HPOS\(7) & (\C1|Add2~4_combout\ & !\C1|LessThan5~11_cout\)) # (!\C1|HPOS\(7) & ((\C1|Add2~4_combout\) # (!\C1|LessThan5~11_cout\))))
...
-- Equation(s):
-- \C1|LessThan5~15_cout\ = CARRY((\C1|Add2~6_combout\ & (\C1|HPOS\(8) & !\C1|LessThan5~13_cout\)) # (!\C1|Add2~6_combout\ & ((\C1|HPOS\(8)) # (!\C1|LessThan5~13_cout\))))
...
-- Equation(s):
-- \C1|DRAW2~1_combout\ = (\C1|LessThan6~20_combout\ & (\C1|DRAW2~0_combout\ & ((\C1|Add2~12_combout\) # (\C1|LessThan5~18_combout\))))
...
-- Equation(s):
-- \C1|R~7_combout\ = (\C1|DRAW2~1_combout\ & ((!\SW~combout\(1)))) # (!\C1|DRAW2~1_combout\ & (\C1|R~6_combout\))
...
-- Equation(s):
-- \C1|Add7~4_combout\ = ((\C1|SQ_Y1\(3) $ (\C1|SQ_Y1[10]~0_combout\ $ (\C1|Add7~3\)))) # (GND)
-- \C1|Add7~5\ = CARRY((\C1|SQ_Y1\(3) & ((!\C1|Add7~3\) # (!\C1|SQ_Y1[10]~0_combout\))) # (!\C1|SQ_Y1\(3) & (!\C1|SQ_Y1[10]~0_combout\ & !\C1|Add7~3\)))
...
-- Equation(s):
-- \C1|SQ_Y1[1]~1_combout\ = (!\C1|SQ_Y1\(5) & (!\C1|SQ_Y1\(4) & (\C1|SQ_Y1\(3) & !\C1|SQ_Y1\(2))))
...
-- Equation(s):
-- \C1|Add7~18_combout\ = \C1|SQ_Y1[10]~0_combout\ $ (\C1|SQ_Y1\(10) $ (!\C1|Add7~17\))
...
-- Equation(s):
-- \C1|SQ_Y1[1]~4_combout\ = (\C1|LessThan11~1_combout\ & (\C1|LessThan12~0_combout\ & ((!\C1|SQ_Y1[1]~3_combout\) # (!\C1|SQ_Y1[10]~0_combout\))))
...
-- Equation(s):
-- \C1|Add7~8_combout\ = ((\C1|SQ_Y1\(5) $ (\C1|SQ_Y1[10]~0_combout\ $ (!\C1|Add7~7\)))) # (GND)
-- \C1|Add7~9\ = CARRY((\C1|SQ_Y1\(5) & (!\C1|SQ_Y1[10]~0_combout\ & !\C1|Add7~7\)) # (!\C1|SQ_Y1\(5) & ((!\C1|Add7~7\) # (!\C1|SQ_Y1[10]~0_combout\))))
...
-- Equation(s):
-- \C1|SQ_X1[1]~1_combout\ = (\C1|LessThan11~1_combout\ & (!\C1|SQ_X1[10]~0_combout\ & (\C1|LessThan12~0_combout\ & \SW~combout\(0))))
...
-- Equation(s):
-- \C1|LessThan1~18_combout\ = (\C1|Add0~14_combout\ & ((\C1|LessThan1~17_cout\) # (!\C1|HPOS\(10)))) # (!\C1|Add0~14_combout\ & (\C1|LessThan1~17_cout\ & !\C1|HPOS\(10)))
...
-- Equation(s):
-- \C1|DRAW1~0_combout\ = (\C1|LessThan2~20_combout\ & ((\C1|Add0~16_combout\) # (\C1|LessThan1~18_combout\)))
...
-- Equation(s):
-- \C1|DRAW1~1_combout\ = (\C1|LessThan0~20_combout\ & (\C1|DRAW1~0_combout\ & ((\C1|LessThan3~18_combout\) # (\C1|Add1~20_combout\))))
...
-- Equation(s):
-- \C1|R~8_combout\ = (\C1|B~0_combout\ & ((\C1|R~7_combout\) # ((\C1|DRAW1~1_combout\ & !\C1|DRAW2~1_combout\))))
...
-- Equation(s):
-- \C1|process_0~12_combout\ = (\C1|HPOS\(8) & (!\C1|LessThan16~0_combout\ & \C1|HPOS\(7)))
...
-- Equation(s):
-- \C1|process_0~8_combout\ = ((\C1|VPOS\(10)) # ((!\C1|LessThan17~1_combout\ & \C1|VPOS\(5)))) # (!\C1|LessThan17~0_combout\)
...
-- Equation(s):
-- \C1|LessThan20~0_combout\ = (!\C1|VPOS\(2) & (!\C1|VPOS\(4) & (!\C1|VPOS\(1) & !\C1|VPOS\(0))))
...
-- Equation(s):
-- \C1|process_0~9_combout\ = (\C1|process_0~8_combout\) # ((!\C1|VPOS\(3) & (!\C1|VPOS\(5) & \C1|LessThan20~0_combout\)))
...
-- Equation(s):
-- \C1|R~0_combout\ = (!\C1|HPOS\(10) & !\C1|HPOS\(9))
...
-- Equation(s):
-- \C1|B~0_combout\ = (\C1|process_0~9_combout\ & ((\C1|process_0~11_combout\) # ((\C1|process_0~12_combout\) # (!\C1|R~0_combout\))))
...
-- Equation(s):
-- \C1|B~1_combout\ = (\C1|DRAW1~1_combout\ & (!\SW~combout\(0))) # (!\C1|DRAW1~1_combout\ & ((\C1|R~6_combout\)))
...
-- Equation(s):
-- \C1|R~9_combout\ = (\C1|B~0_combout\ & ((\C1|DRAW2~1_combout\) # ((\C1|DRAW1~1_combout\) # (\C1|R~6_combout\))))
...
-- Equation(s):
-- \C1|G~0_combout\ = (\C1|R~9_combout\ & (((\C1|DRAW2~1_combout\) # (!\SW~combout\(0))) # (!\C1|DRAW1~1_combout\)))
